        ...
        <NuxtLink :to="`/item/${product.id}`">
            ...
            <div id="ProductDetails">
                ...
                <span class="flex items-center justify-start gap-3 px-1 pt-1">
                    <span class="text-[#FFAA46] font-semibold">${{ priceComputed }}</span>
                    <span class="text-gray-500 text-sm text-light line-through">${{ oldPriceComputed }}</span>
                </span>

                <span class="px-1 relative -top-1.5 text-[#FFAA46] text-xs font-semibold">
                    Extra 5% off
                </span>

                <div class="flex items-center gap-1 px-1 relative -top-1">
                    <span class="bg-[#000] text-white text-[9px] font-semibold px-1.5 rounded-sm">Welcome Deal</span>
                    <span class="bg-[#F5F5F5] border text-[#FFAA46] text-[9px] font-semibold px-1.5 rounded-sm">Top Selling</span>
                </div>
                ...
                <p class="px-1 pb-1">
                    <span class="text-[#FFAA46] text-xs font-semibold">Free Shipping</span>
                </p>
