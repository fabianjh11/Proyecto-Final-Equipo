        ...
        <div class="my-auto">
            ...
            >
                <div 
                    ...
                    :class="[
                        isHover ? 'border-[#FFAA46]' : 'border-gray-300',
                        isSelected ? 'bg-[#FFAA46]' : ''
                    ]"
                >
        ...
        <div class="overflow-hidden pl-2 w-full">
            <div class="flex items-center justify-between w-full">
                <div class="flex items-center justify-between truncate">
                    <span class="sm:block hidden bg-[#FFAA46] text-white text-[9px] font-semibold px-1.5 rounded-sm min-w-[80px]">Welcome Deal</span>
            ...
            <p class="text-[#FFAA46] text-xs font-semibold pt-1">
