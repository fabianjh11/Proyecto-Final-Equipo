    ...
    <div id="MainLayout" class="w-full fixed z-50">
        ...
        >
            ...
            >
                <li 
                    ...
                    class="relative flex items-center px-2.5 hover:text-[#FFAA46] h-full cursor-pointer"
                ...
                >
                    ...
                    >
                        <div v-if="!user">
                            <div class="text-semibold text-[15px] my-4 px-3">Welcome to Shopin!</div>
                            <div class="flex items-center gap-1 px-3 mb-3">
                                <NuxtLink 
                                    to="/auth"
                                    class="bg-[#FFAA46] text-center w-full text-[16px] rounded-sm text-white font-semibold p-2"
                                >
                                    Login / Register
                                </NuxtLink>
                            </div>
        ...
        >
            <div class="flex lg:justify-start justify-between gap-10 max-w-[1150px] w-full px-3 py-5 mx-auto">
                <NuxtLink to="/" class="max-w-[170px] flex justify-between gap-2 items-center">
                    <img 
                        width="60"
                        src="/logo.png"
                    >
                    <h1 class="font-bold text-3xl">Shopin</h1>
                </NuxtLink>

                <div class="max-w-[700px] w-full md:block hidden place-self-center">
                    <div class="relative">
                        <div class="flex items-center border-2 border-[#FFAA46] rounded-md w-full">
                            <input 
                                class="
                                    w-full
                            ...
                            <Icon 
                                ...
                                class="mr-2"
                            />
                            <button class="flex items-center h-[100%] p-1.5 px-2 bg-[#FFAA46]">
