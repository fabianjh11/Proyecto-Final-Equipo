            ...
            <div class="md:flex gap-4 justify-between mx-auto w-full">
                    ...
                    <div v-if="images[0] !== ''" class="flex items-center justify-center mt-2">
                        <div v-for="image in images">
                            <img 
                                ...
                                :class="currentImage === image ? 'border-[#FFAA46]' : ''"
                                :src="image"
                            >
                        </div>
                    </div>
                ...
                <div class="md:w-[60%] bg-white p-3 rounded-lg">
                    ...
                    <div class="flex items-center pt-1.5">
                        <span class="h-4 min-w-4 rounded-full p-0.5 bg-[#FFAA46] mr-2">
                            <Icon name="material-symbols:star-rounded" class="-mt-[17px]" size="12"/>
                        </span>
                        <p class="text-[#FFAA46]">Extra 5% off</p>
                    </div>

                    <div class="flex items-center justify-start my-2">
                        <Icon name="ic:baseline-star" color="#FFAA46"/>
                        <Icon name="ic:baseline-star" color="#FFAA46"/>
                        <Icon name="ic:baseline-star" color="#FFAA46"/>
                        <Icon name="ic:baseline-star" color="#FFAA46"/>
                        <Icon name="ic:baseline-star" color="#FFAA46"/>
                    ...
                    <p class="text-[#FFAA50] text-xs font-semibold pt-1">
