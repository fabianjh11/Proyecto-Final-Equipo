            ...
            <div class="md:flex gap-4 justify-between mx-auto w-full">
                <div class="md:w-[65%]">
                    <div class="bg-white rounded-lg p-4">
                        ...
                        <div v-if="currentAddress && currentAddress.data">
                            <NuxtLink 
                                to="/address"
                                class="flex items-center pb-2 text-yellow-400 hover:text-yellow-600"
                            >
                        ...
                        <NuxtLink 
                            v-else
                            to="/address"
                            class="flex items-center text-yellow-400 hover:text-yellow-600"
                        >
                            <Icon name="mdi:plus" size="18" class="mr-2"/>
                            Add New Address
                        </NuxtLink>
                ...
                <div class="md:w-[35%]">
                    ...
                    <div class="bg-white rounded-lg p-4 mt-4">
                        <div class="text-lg font-semibold mb-2 mt-2">Shopin</div>
                        <p class="my-2">
                            Shopin keeps your information and payment safe
                        </p>
